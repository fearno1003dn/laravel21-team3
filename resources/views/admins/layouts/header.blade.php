<header class="main-header">
    ...
    <a href="." class="logo">
        ...
        <span><img src="{{asset('images/logos/site-logo.png')}}" style='width: 170px; height: 40px'/></span>

        <!-- <span><img src="{{asset('images/logos/site-logo.png')}}" style='width: 200px; height: 40px'/></span> -->
    </a>
