...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
          href="{{asset('AdminLTE-2.4.1/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}">
    <!-- Daterange picker -->
    <link rel="stylesheet"
          href="{{asset('AdminLTE-2.4.1/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
