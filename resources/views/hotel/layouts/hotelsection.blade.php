                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#pick-up" aria-controls="pick-up" role="tab" data-toggle="tab"><img
                                        src="{{asset('hotel-booking/img/home-facilities-icon-eight.png')}}"
                                        alt="pick-up"><span>pick-up</span></a>
                        </li>
                        <li role="presentation">
                            <a href="#bar" aria-controls="bar" role="tab" data-toggle="tab"><img
                                        src="{{asset('hotel-booking/img/home-facilities-icon-nine.png')}}"
                                        alt="bar"><span>bar</span></a>
                        </li>
                        <li role="presentation">
                            <a href="#gym" aria-controls="gym" role="tab" data-toggle="tab"><img
                                        src="{{asset('hotel-booking/img/home-facilities-icon-ten.png')}}"
                                        alt="gym"><span>gym</span></a>
                        </li>
                    </ul>
                                ...
                                <div class="row">
                                    <div class="co-lg-5 col-md-5 col-sm-6">
                                        <div class="single-tab-image">
                                            <img src="{{asset('hotel-booking/img/hotel-facility-one.jpg')}}"
                                                 alt="">
                                        </div>
                                    </div>
                                    <div class="co-lg-7 col-md-7 col-sm-6">
                                        <div class="single-tab-details">
                                            ...
                                            <p>
                                                Cras ac justo et augue suscipit euismod vel eget lectus. Proin vehicula
                                                nunc arcu, pulvinar accumsan nulla porta vel. Vivamus malesuada vitae
                                                sem ac pellentesque.
                                            </p>
                                            <div class="our_services">
                                                Service Hours; 19.00-22:00 <br>
                                                Service charge : $15
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="single-tab-content">
                                <div class="row">
                                    <div class="co-lg-5 col-md-5">
                                        <div class="single-tab-image">
                                            <img
                                                    src="{{asset('hotel-booking/img/hotel-facility-three.jpg')}}"
                                                    alt=""></div>
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="bar">
                            <div class="single-tab-content">
                                <div class="row">
                                    <div class="co-lg-5 col-md-5">
                                        <div class="single-tab-image">
                                            <img src="{{asset('hotel-booking/img/hotel-facility-three.jpg')}}"
                                                 alt="">
                                        </div>
                                    </div>
                                    <div class="co-lg-7 col-md-7">
