            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="image1" class="col-md-4 control-label">Upload Image 1</label>
                        ...
                        <div class="form-group">
                            <label for="image2" class="col-md-4 control-label">Upload Image 2</label>
                        ...
                        <div class="form-group">
                            <label for="image3" class="col-md-4 control-label">Upload Image 3</label>
